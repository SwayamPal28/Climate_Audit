...
def get_graph_data():
    try:
        ...
        if edges_path.exists():
            ...
            edge_feature_cols = ['primaryValue', 'netWgt', 'distance_km', 'transport_emissions_tCO2']
            final_link_cols = ['source', 'target'] + [c for c in edge_feature_cols if c in valid_edges.columns]
